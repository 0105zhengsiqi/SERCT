...
def evaluate(model, device, speech):
...
if __name__ == "__main__":
    ...
    ckpt = torch.load('ckpts/cnn-transformer-mix-50.pt')
    ...
    wav_path = 'app/emotions/angry-00000.wav'

    speech = file_to_array(wav_path, None)
    evaluate(model, device, speech)
